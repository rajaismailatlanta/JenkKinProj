...
public class ERAbstractActions{
	
	WebDriver driver;
	public ERAbstractActions(WebDriver driver) {
	...
	public void tab(WebDriver driver, WebElement theElement){
		
		System.out.println("Inside actions/tab function due to order button issue");
		Actions act = new Actions(driver);
		
		act.moveToElement(theElement).click(theElement);
		act.build().perform();
	}
	
	public void waitForCartButtonToAppearAfterAddToCart() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(1));
